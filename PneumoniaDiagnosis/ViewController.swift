...
class ViewController: UIViewController,UIImagePickerControllerDelegate,UINavigationControllerDelegate{
    let imagePicker = UIImagePickerController()
      ...
      override func viewDidLoad() {
        ...
        navigationItem.title = " Pneumonia Diagnosis Application👨🏻‍⚕️🏨"
       ...
       guard let filterModel = try? VNCoreMLModel(for: Inceptionv3().model)
        ...
        if filterOp.contains("Isopod"){
            ...
            DispatchQueue.main.async {
                ...
                self.sendAlert(title: "Invalid Image", message: "Upload only Chest Xray Images for the Detection", Buttontitle: "OK")
            }
        }
    }
